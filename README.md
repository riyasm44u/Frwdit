...
### Deploy on Heroku
[![Deploy](https://www.herokucdn.com/deploy/button.svg)](https://heroku.com/deploy?template=https://github.com/Jijinr/Frwdit/fork)
...
Deploy in your vps
```sh
git clone https://github.com/Jijinr/Frwdit/fork
cd Frwit
